...
CREATE TABLE "ASBadanie" ("id" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , "id_badanie" INTEGER NOT NULL , "id_as" INTEGER NOT NULL , "data" DATETIME NOT NULL , "prev_as_in_cidr" INTEGER NOT NULL );
